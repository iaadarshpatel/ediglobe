                ...
                <div className="row align-items-center" data-aos="fade-right">
                    <div className="col-lg">
                        <div className="row clock_sec clockdiv image-row" id="clockdiv">
                            ...
                            <img loading="lazy" className="image-01" alt="" src="https://assets-global.website-files.com/624629162e6c5c363b391aee/641bfdb90d930737f73e2daa_Frame%201430102672%20(1).svg"></img>
                            <img loading="lazy" className="image-01" alt="" src="https://assets-global.website-files.com/624629162e6c5c363b391aee/641bf2e30d93075fc53d83c3_Ogilvy%20svg.svg"></img>
